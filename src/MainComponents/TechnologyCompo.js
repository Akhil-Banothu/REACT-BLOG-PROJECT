  ...
  return (
    <div className="article-container">
      <div className="article-category">
        ...
        {Data.filter((article) => article.footer === 'Technology').map((item, index) => {
          return (
      ...
      <div className="article-top-post">
        <h2>Top Posts</h2>
        <hr className="article-decoration" />
        {Data.filter((article) => article.content === 'Technology1').map((item, index) => {
          return (
            <div key={index}>
        ...
        {Data.filter((article) => article.footer === 'TechnologyTP').map((item, index) => {
          return (
            <div key={index}>
        ...
        <div className='advertisement'>
          <img src="https://newspaperads.ads2publish.com/wp-content/uploads/2018/01/tata-consultancy-services-experience-powered-through-technology-ad-bombay-times-04-01-2018.png" alt='Technology advertisement component' />
        </div>
      </div>
...
export default TechnologyCompo